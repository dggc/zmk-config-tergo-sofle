...
ROMAO_X(CAPSLINE,  "CASE2") \
ROMAO_X(ALPHA2,  "ROMAK2") \
ROMAO_X(NUMBERS,  "NUM") \
ROMAO_X(SYMBOLS,  "SYM") \
ROMAO_X(SENTENCE_CASE,  "CASE") \
ROMAO_X(CCEDIL,  "Ç EXT") \
ROMAO_X(SHIFTED_ALPHA2,  "ROMAKS2") \
ROMAO_X(CASE_ALPHA2,  "CASEA2") \
ROMAO_X(CASE_CCEDIL,  "CASEC") \
ROMAO_X(SHORTCUTS,  "SHORTS") \
// ROMAO_X(MEHS,  "MEHS") \
// ROMAO_X(PLAIN1,  "PLAIN") \
// ROMAO_X(PLAIN2,  "PLAIN2") \
// ROMAO_X(SHIFTED_PLAIN2,  "PLAINS2") \
// ROMAO_X(SECONDARY_ALTERNATE_REPEAT,  "ROMAK3") \
// ROMAO_X(NAVIGATION,  "NAV") \
// ROMAO_X(NUMBERS_COPY,  "NUM2") \
// ROMAO_X(SYMBOLS_COPY,  "SYM2") \
// ROMAO_X(MEDIA,  "MOUSE") \
// ROMAO_X(NAVIGATION_COPY,  "NAV2") \
// ROMAO_X(TEXT,  "TEXT") \
